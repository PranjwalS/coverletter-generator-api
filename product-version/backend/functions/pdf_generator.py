...
#   /* 
#     .page padding controls ALL spacing — both in browser (iframe) and PDF.
#     @page margin is 0 so WeasyPrint doesn't add extra margin on top.
#     This makes browser and PDF appearance identical.
#   */
#   .page {{
#     width: 100%;
#     padding: 10% 11%;
...
# def html_to_pdf(html_string: str) -> bytes:
#     """
#     @page margin 0 — all spacing comes from .page padding in the HTML itself.
#     This makes the PDF match the browser iframe exactly.
#     """
#     page_css = CSS(string="""
#         @page {
#             size: letter;
